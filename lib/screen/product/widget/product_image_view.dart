                    ...
                    children: [
                          ...
                          child: productModel.image != null?PageView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return FadeInImage.assetNetwork(fit: BoxFit.cover,
                                placeholder: Images.placeholder, height: MediaQuery.of(context).size.width/2,
                                width: MediaQuery.of(context).size.width/2,
                                image: '${productModel.image}',
                                imageErrorBuilder: (c, o, s) => Image.asset(
                                  Images.placeholder, height: MediaQuery.of(context).size.width/2,
                      ...
                      Positioned(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            IconButton(icon: Icon(Icons.arrow_back_ios_new, color: ColorResources.HINT_TEXT_COLOR,), onPressed: () {
                            ...
                            Spacer(),
                            Image.asset(Images.heart, height: 20, width: 20, color: ColorResources.HINT_TEXT_COLOR,),
                          ],
                        ),
                      ),
  ...
  List<Widget> _indicators(BuildContext context) {
    ...
    for (int index = 0; index < 5; index++) {
      indicators.add(TabPageSelectorIndicator(
        ...
        ColorResources.BLACK : ColorResources.HINT_TEXT_COLOR,
        borderColor: ColorResources.WHITE,
        size: index == Provider.of<ProductDetailsProvider>(context).imageSliderIndex ? 15:10,
      ));
    }
    return indicators;
  }
